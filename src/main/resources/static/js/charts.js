...
// ─────────────────────────────────────────────────────────────
const CHART_CONFIGS = {
    1: { xKey:'pressure', yKey:'electronDensity', zKey:'voltage', xLabel:'p (Па)', yLabel:'nₑ (м⁻³)', zLabel:'U (В)', title:'Плотность электронов от давления', category:'plasma' },
    2: { xKey:'voltage', yKey:'electronVelocity', zKey:'currentDensity', xLabel:'U (В)', yLabel:'vₑ (м/с)', zLabel:'j (А/м²)', title:'Скорость электронов от напряжения', category:'plasma' },
    3: { xKey:'voltage', yKey:'currentDensity', zKey:'ionEnergy', xLabel:'U (В)', yLabel:'j (А/м²)', zLabel:'Eᵢ (Дж)', title:'Плотность тока от напряжения', category:'plasma' },
    4: { xKey:'voltage', yKey:'electronTemperature', zKey:'currentDensity', xLabel:'U (В)', yLabel:'Tₑ (°K)', zLabel:'j (А/м²)', title:'Температура электронов', category:'thermal' },
    5: { xKey:'totalTransferredEnergy', yKey:'depths', zKey:'avgT', xLabel:'E_total (Дж)', yLabel:'d (м)', zLabel:'T̄ (°K)', title:'Температура от энергии и глубины', category:'thermal' },
    6: { xKey:'voltage', yKey:'depths', zKey:'avgT', xLabel:'U (В)', yLabel:'d (м)', zLabel:'T̄ (°K)', title:'Температура от напряжения и глубины', category:'thermal' },
    7: { xKey:'pressure', yKey:'depths', zKey:'avgT', xLabel:'p (Па)', yLabel:'d (м)', zLabel:'T̄ (°K)', title:'Температура от давления и глубины', category:'thermal' },
    8: { xKey:'currentDensity', yKey:'depths', zKey:'avgT', xLabel:'j (А/м²)', yLabel:'d (м)', zLabel:'T̄ (°K)', title:'Температура от плотности тока и глубины', category:'thermal' },
    9: { xKey:'voltage', yKey:'currentDensity', zKey:'totalTransferredEnergy', xLabel:'U (В)', yLabel:'j (А/м²)', zLabel:'E_total (Дж)', title:'Полная энергия от напряжения и плотности тока', category:'energy' },
    10: { xKey:'voltage', yKey:'avgTransferredPerAtom', zKey:'concentration', xLabel:'U (В)', yLabel:'ε̄ (эВ)', zLabel:'n (м⁻³)', title:'Энергия на атом от напряжения и температуры', category:'energy' },
    11: { xKey:'voltage', yKey:'ionEnergy', zKey:'concentration', xLabel:'U (В)', yLabel:'Eᵢ (эВ)', zLabel:'n (м⁻³)', title:'Энергия иона от напряжения и концентрации', category:'energy' },
    12: { xKey:'diffusionCoefficient1', yKey:'totalTransferredEnergy', zKey:'avgT', xLabel:'D₁ (м²/с)', yLabel:'E_total (эВ)', zLabel:'T̄ (°K)', title:'D₁ от температуры и энергии', category:'diffusion' },
    13: { xKey:'totalTransferredEnergy', yKey:'totalDamage', zKey:'avgT', xLabel:'E_total (эВ)', yLabel:'D_total (дефекты/м²)', zLabel:'T̄ (°K)', title:'Энергия → Повреждения при разных температурах', category:'damage' },
    14: { xKey:'totalTransferredEnergy', yKey:'voltage', zKey:'avgT', xLabel:'E_total (эВ)', yLabel:'U (В)', zLabel:'T̄ (°K)', title:'Энергия от температуры и напряжения', category:'energy' },
    15: { xKey:'pressure', yKey:'totalTransferredEnergy', zKey:'avgT', xLabel:'p (Па)', yLabel:'E_total (эВ)', zLabel:'T̄ (°K)', title:'Энергия от давления и температуры', category:'energy' },
    16: { xKey:'diffusionCoefficient1', yKey:'voltage', zKey:'avgT', xLabel:'D₁ (м²/с)', yLabel:'U (В)', zLabel:'T̄ (°K)', title:'D₁ от температуры и напряжения', category:'diffusion' },
    17: { xKey:'diffusionCoefficient2', yKey:'voltage', zKey:'avgT', xLabel:'D₂ (м²/с)', yLabel:'U (В)', zLabel:'T̄ (°K)', title:'D₂ от температуры и напряжения', category:'diffusion' },
    18: { xKey:'diffusionCoefficient1', yKey:'diffusionCoefficient2', zKey:'avgT', xLabel:'D₁ (м²/с)', yLabel:'D₂ (м²/с)', zLabel:'T̄ (°K)', title:'Сравнение D₁ и D₂ при разных температурах', category:'diffusion' },
    19: { xKey:'voltage', yKey:'diffusionCoefficient1', zKey:'avgT', xLabel:'U (В)', yLabel:'D₁ (м²/с)', zLabel:'T̄ (°K)', title:'Диффузия D₁ от напряжения и температуры', category:'diffusion' },
    20: { xKey:'diffusionCoefficient1', yKey:'diffusionCoefficient2', zKey:'avgT', xLabel:'D₁ (м²/с)', yLabel:'D₂ (м²/с)', zLabel:'T̄ (°K)', title:'Сравнение D₁ и D₂ при разных температурах после SLR', category:'diffusion' },
    21: { xKey:'totalTransferredEnergy', yKey:'totalDamage', zKey:'avgT', xLabel:'E_total (эВ)', yLabel:'D_total (дефекты/м²)', zLabel:'T̄ (°K)', title:'Повреждения от энергии и температуры', category:'damage' },
    22: { xKey:'totalTransferredEnergy', yKey:'totalMomentum', zKey:'totalDamage', xLabel:'E_total (эВ)', yLabel:'p_total (кг·м/с)', zLabel:'D_total (дефекты/м²)', title:'Импульс от энергии и повреждений', category:'damage' },
    23: { xKey:'totalMomentum', yKey:'totalDisplacement', zKey:'totalDamage', xLabel:'p_total (кг·м/с)', yLabel:'Δr (м)', zLabel:'D_total (дефекты/м²)', title:'Смещение от импульса и повреждений', category:'damage' },
    24: { xKey:'totalDamage', yKey:'voltage', zKey:'avgT', xLabel:'D_total (дефекты/м²)', yLabel:'U (В)', zLabel:'T̄ (°K)', title:'Повреждения от температуры и напряжения', category:'damage' },
    25: { xKey:'voltage', yKey:'currentDensity', zKey:'depths', xLabel:'U (В)', yLabel:'j (А/м²)', zLabel:'d (м)', title:'V · j → Глубина проникновения ионов', category:'plasma' },
    26: { xKey:'voltage', yKey:'currentDensity', zKey:'ionEnergy', xLabel:'U (В)', yLabel:'j (А/м²)', zLabel:'Eᵢ (Дж)', title:'V · j → Суммарная переданная энергия', category:'energy' },
    27: { xKey:'avgT', yKey:'pressure', zKey:'concentration', xLabel:'T̄ (°K)', yLabel:'p (Па)', zLabel:'n (м⁻³)', title:'T · P → Концентрация', category:'plasma' },
    28: { xKey:'avgT', yKey:'voltage', zKey:'totalDamage', xLabel:'T̄ (°K)', yLabel:'U (В)', zLabel:'D_total (дефекты/м²)', title:'T · V → Суммарные повреждения', category:'damage' },
    29: { xKey:'electronDensity', yKey:'electronTemperature', zKey:'pressure', xLabel:'nₑ (м⁻³)', yLabel:'Tₑ (°K)', zLabel:'p (Па)', title:'Давление от параметров плазмы', category:'plasma' },
    30: { xKey:'ionEnergy', yKey:'electronTemperature', zKey:'electronDensity', xLabel:'Eᵢ (эВ)', yLabel:'Tₑ (°K)', zLabel:'nₑ (м⁻³)', title:'Плотность электронов от энергетики', category:'plasma' },
    31: { xKey:'currentDensity', yKey:'electronDensity', zKey:'electronVelocity', xLabel:'j (А/м²)', yLabel:'nₑ (м⁻³)', zLabel:'vₑ (м/с)', title:'Кинетика электронов от тока и концентрации', category:'plasma' },
    32: { xKey:'pressure', yKey:'electronTemperature', zKey:'currentDensity', xLabel:'p (Па)', yLabel:'Tₑ (°K)', zLabel:'j (А/м²)', title:'Ток от термодинамических параметров плазмы', category:'plasma' },
    33: { xKey:'voltage', yKey:'pressure', zKey:'electronDensity', xLabel:'U (В)', yLabel:'p (Па)', zLabel:'nₑ (м⁻³)', title:'Разрядные характеристики: V·P → n_e', category:'plasma' },
    34: { xKey:'ionEnergy', yKey:'avgTransferredPerAtom', zKey:'totalTransferredEnergy', xLabel:'Eᵢ (эВ)', yLabel:'ε̄ (эВ)', zLabel:'E_total (Дж)', title:'Баланс энергии: ион → атом → полная', category:'energy' },
    35: { xKey:'voltage', yKey:'electronVelocity', zKey:'totalTransferredEnergy', xLabel:'U (В)', yLabel:'vₑ (м/с)', zLabel:'E_total (Дж)', title:'Энергопередача от скорости электронов', category:'energy' },
    36: { xKey:'currentDensity', yKey:'avgTransferredPerAtom', zKey:'concentration', xLabel:'j (А/м²)', yLabel:'ε̄ (эВ)', zLabel:'n (м⁻³)', title:'Концентрация от энергопередачи', category:'energy' },
    37: { xKey:'totalMomentum', yKey:'ionEnergy', zKey:'totalTransferredEnergy', xLabel:'p_total (кг·м/с)', yLabel:'Eᵢ (эВ)', zLabel:'E_total (Дж)', title:'Связь импульса и энергии в столкновениях', category:'energy' },
    38: { xKey:'totalTransferredEnergy', yKey:'depths', zKey:'concentration', xLabel:'E_total (Дж)', yLabel:'d (м)', zLabel:'n (м⁻³)', title:'Профиль концентрации от энергии и глубины', category:'energy' },
    39: { xKey:'avgTransferredPerAtom', yKey:'pressure', zKey:'totalDamage', xLabel:'ε̄ (эВ)', yLabel:'p (Па)', zLabel:'D_total (дефекты/м²)', title:'Повреждения от энергии на атом и давления', category:'damage' },
    40: { xKey:'totalDamage', yKey:'totalDisplacement', zKey:'concentration', xLabel:'D_total (дефекты/м²)', yLabel:'Δr (м)', zLabel:'n (м⁻³)', title:'Концентрация от повреждений и смещений', category:'damage' },
    41: { xKey:'totalMomentum', yKey:'totalDamage', zKey:'avgT', xLabel:'p_total (кг·м/с)', yLabel:'D_total (дефекты/м²)', zLabel:'T̄ (°K)', title:'Температурные эффекты от импульса и повреждений', category:'damage' },
    42: { xKey:'currentDensity', yKey:'totalDamage', zKey:'totalTransferredEnergy', xLabel:'j (А/м²)', yLabel:'D_total (дефекты/м²)', zLabel:'E_total (Дж)', title:'Энергетический баланс при дефектообразовании', category:'damage' },
    43: { xKey:'ionEnergy', yKey:'totalDisplacement', zKey:'totalDamage', xLabel:'Eᵢ (эВ)', yLabel:'Δr (м)', zLabel:'D_total (дефекты/м²)', title:'Каскады смещений от энергии иона', category:'damage' },
    44: { xKey:'voltage', yKey:'totalDisplacement', zKey:'depths', xLabel:'U (В)', yLabel:'Δr (м)', zLabel:'d (м)', title:'Глубина проникновения дефектов', category:'damage' },
    45: { xKey:'pressure', yKey:'totalDamage', zKey:'totalDisplacement', xLabel:'p (Па)', yLabel:'D_total (дефекты/м²)', zLabel:'Δr (м)', title:'Влияние давления на смещения', category:'damage' },
    46: { xKey:'avgT', yKey:'totalDamage', zKey:'diffusionCoefficient1', xLabel:'T̄ (°K)', yLabel:'D_total (дефекты/м²)', zLabel:'D₁ (м²/с)', title:'Термоактивированная диффузия в повреждённом материале', category:'diffusion' },
    47: { xKey:'avgT', yKey:'concentration', zKey:'diffusionCoefficient1', xLabel:'T̄ (°K)', yLabel:'n (м⁻³)', zLabel:'D₁ (м²/с)', title:'Классическая зависимость D(T, C)', category:'diffusion' },
    48: { xKey:'totalTransferredEnergy', yKey:'diffusionCoefficient1', zKey:'concentration', xLabel:'E_total (Дж)', yLabel:'D₁ (м²/с)', zLabel:'n (м⁻³)', title:'Радиационно-ускоренная диффузия', category:'diffusion' },
    49: { xKey:'diffusionCoefficient1', yKey:'depths', zKey:'concentration', xLabel:'D₁ (м²/с)', yLabel:'d (м)', zLabel:'n (м⁻³)', title:'Диффузионный профиль концентрации', category:'diffusion' },
    50: { xKey:'avgT', yKey:'diffusionCoefficient2', zKey:'totalDamage', xLabel:'T̄ (°K)', yLabel:'D₂ (м²/с)', zLabel:'D_total (дефекты/м²)', title:'Вторая мода диффузии и дефекты', category:'diffusion' },
    51: { xKey:'pressure', yKey:'avgT', zKey:'diffusionCoefficient1', xLabel:'p (Па)', yLabel:'T̄ (°K)', zLabel:'D₁ (м²/с)', title:'Термобарическая диффузия', category:'diffusion' },
    52: { xKey:'voltage', zKey:'totalTransferredEnergy', yKey:'diffusionCoefficient2', xLabel:'U (В)', zLabel:'E_total (Дж)', yLabel:'D₂ (м²/с)', title:'Энергетическая стимуляция второй моды диффузии', category:'diffusion' },
    53: { xKey:'ionEnergy', yKey:'pressure', zKey:'depths', xLabel:'Eᵢ (эВ)', yLabel:'p (Па)', zLabel:'d (м)', title:'Пробег ионов от энергии и давления', category:'plasma' },
    54: { xKey:'electronTemperature', yKey:'ionEnergy', zKey:'totalTransferredEnergy', xLabel:'Tₑ (°K)', yLabel:'Eᵢ (эВ)', zLabel:'E_total (Дж)', title:'Энергообмен электрон-ион-атом', category:'energy' },
    55: { xKey:'currentDensity', yKey:'totalTransferredEnergy', zKey:'avgT', xLabel:'j (А/м²)', yLabel:'E_total (Дж)', zLabel:'T̄ (°K)', title:'Нагрев от плотности тока и энергопередачи', category:'thermal' },
    56: { xKey:'voltage', yKey:'depths', zKey:'concentration', xLabel:'U (В)', yLabel:'d (м)', zLabel:'n (м⁻³)', title:'Профиль концентрации от напряжения и глубины', category:'energy' },
    57: { xKey:'electronVelocity', yKey:'ionEnergy', zKey:'currentDensity', xLabel:'vₑ (м/с)', yLabel:'Eᵢ (эВ)', zLabel:'j (А/м²)', title:'Транспортные свойства плазмы', category:'plasma' },
    58: { xKey:'totalMomentum', yKey:'avgT', zKey:'totalDisplacement', xLabel:'p_total (кг·м/с)', yLabel:'T̄ (°K)', zLabel:'Δr (м)', title:'Термоактивированные смещения', category:'damage' },
    59: { xKey:'diffusionCoefficient1', yKey:'totalTransferredEnergy', zKey:'depths', xLabel:'D₁ (м²/с)', yLabel:'E_total (Дж)', zLabel:'d (м)', title:'Глубина диффузии от энергии', category:'diffusion' },
    60: { xKey:'concentration', yKey:'avgT', zKey:'totalDamage', xLabel:'n (м⁻³)', yLabel:'T̄ (°K)', zLabel:'D_total (дефекты/м²)', title:'Отжиг дефектов', category:'damage' },
    61: { xKey:'ionFlux', yKey:'fluence', zKey:'currentDensity', xLabel:'Φ (м⁻²·с⁻¹)', yLabel:'F (м⁻²)', zLabel:'j (А/м²)', title:'Накопление флюенса по потоку и плотности тока', category:'fluence' },
    62: { xKey:'fluence', yKey:'totalDamage', zKey:'avgT', xLabel:'F (м⁻²)', yLabel:'D_total (дефекты/м²)', zLabel:'T̄ (°K)', title:'Повреждения от интегрального флюенса', category:'fluence' },
    63: { xKey:'fluence', yKey:'concentration', zKey:'depths', xLabel:'F (м⁻²)', yLabel:'n (м⁻³)', zLabel:'d (м)', title:'Профиль концентрации от флюенса', category:'fluence' },
    64: { xKey:'fluence', yKey:'fluenceEff', zKey:'resonanceXi', xLabel:'F (м⁻²)', yLabel:'F_eff (м⁻²)', zLabel:'ξ', title:'Эффективный флюенс: реальный vs усиленный', category:'fluence' },
    65: { xKey:'voltage', yKey:'fluence', zKey:'ionFlux', xLabel:'U (В)', yLabel:'F (м⁻²)', zLabel:'Φ (м⁻²·с⁻¹)', title:'Накопление дозы от режима разряда', category:'fluence' },
    66: { xKey:'ionEnergy', yKey:'resonanceXi', zKey:'concentration', xLabel:'Eᵢ (эВ)', yLabel:'ξ', zLabel:'n (м⁻³)', title:'Резонансное усиление от энергии иона', category:'resonance' },
    67: { xKey:'resonanceXi', yKey:'dRes', zKey:'diffusionCoefficient1', xLabel:'ξ', yLabel:'D_res (м²/с)', zLabel:'D₁ (м²/с)', title:'Резонансный вклад в диффузию', category:'resonance' },
    68: { xKey:'voltage', yKey:'resonanceXi', zKey:'pressure', xLabel:'U (В)', yLabel:'ξ', zLabel:'p (Па)', title:'Резонанс от параметров плазмы', category:'resonance' },
    69: { xKey:'resonanceXi', yKey:'fluenceEff', zKey:'totalDamage', xLabel:'ξ', yLabel:'F_eff (м⁻²)', zLabel:'D_total (дефекты/м²)', title:'Усиление флюенса и повреждения', category:'resonance' },
    70: { xKey:'avgT', yKey:'resonanceXi', zKey:'dRes', xLabel:'T̄ (°K)', yLabel:'ξ', zLabel:'D_res (м²/с)', title:'Температурная зависимость резонансной диффузии', category:'resonance' },
    71: { xKey:'fluence', yKey:'dSlr', zKey:'totalDamage', xLabel:'F (м⁻²)', yLabel:'D_SLR (м²/с)', zLabel:'D_total (дефекты/м²)', title:'SLR-диффузия от флюенса и повреждений', category:'slr' },
    72: { xKey:'dSlr', yKey:'diffusionCoefficient1', zKey:'avgT', xLabel:'D_SLR (м²/с)', yLabel:'D₁ (м²/с)', zLabel:'T̄ (°K)', title:'Вклад SLR в термическую диффузию', category:'slr' },
    73: { xKey:'voltage', yKey:'dSlr', zKey:'currentDensity', xLabel:'U (В)', yLabel:'D_SLR (м²/с)', zLabel:'j (А/м²)', title:'SLR от режима обработки', category:'slr' },
    74: { xKey:'totalDamage', yKey:'dSlr', zKey:'fluenceEff', xLabel:'D_total (дефекты/м²)', yLabel:'D_SLR (м²/с)', zLabel:'F_eff (м⁻²)', title:'Баллистическое перемешивание', category:'slr' },
    75: { xKey:'pressure', yKey:'dSlr', zKey:'ionFlux', xLabel:'p (Па)', yLabel:'D_SLR (м²/с)', zLabel:'Φ (м⁻²·с⁻¹)', title:'SLR от параметров потока', category:'slr' },
    76: { xKey:'dSlr', yKey:'dRes', zKey:'diffusionCoefficient1', xLabel:'D_SLR (м²/с)', yLabel:'D_res (м²/с)', zLabel:'D₁ (м²/с)', title:'Сравнение механизмов радиационной диффузии', category:'rad_diffusion' },
    77: { xKey:'dSlr_plus_dRes', yKey:'diffusionCoefficient1', zKey:'avgT', xLabel:'D_SLR + D_res (м²/с)', yLabel:'D₁ (м²/с)', zLabel:'T̄ (°K)', title:'Полная радиационная диффузия', category:'rad_diffusion' },
    78: { xKey:'diffusionCoefficient1', yKey:'diffusionCoefficient2', zKey:'fluenceEff', xLabel:'D₁ (м²/с)', yLabel:'D₂ (м²/с)', zLabel:'F_eff (м⁻²)', title:'Сравнение коэффициентов диффузии от флюенса', category:'rad_diffusion' },
    79: { xKey:'ionEnergy', yKey:'dSlr_plus_dRes', zKey:'totalDamage', xLabel:'Eᵢ (эВ)', yLabel:'D_SLR + D_res (м²/с)', zLabel:'D_total (дефекты/м²)', title:'Энергетическая стимуляция диффузии', category:'rad_diffusion' },
    80: { xKey:'depths', yKey:'diffusionCoefficient1', zKey:'dRes', xLabel:'d (м)', yLabel:'D₁ (м²/с)', zLabel:'D_res (м²/с)', title:'Профиль радиационной диффузии', category:'rad_diffusion' },
    81: { xKey:'ionFlux', yKey:'concentration', zKey:'depths', xLabel:'Φ (м⁻²·с⁻¹)', yLabel:'n (м⁻³)', zLabel:'d (м)', title:'Концентрация от ионного потока и глубины', category:'flux' },
    82: { xKey:'ionFlux', yKey:'totalDamage', zKey:'avgT', xLabel:'Φ (м⁻²·с⁻¹)', yLabel:'D_total (дефекты/м²)', zLabel:'T̄ (°K)', title:'Скорость дефектообразования', category:'flux' },
    83: { xKey:'currentDensity', yKey:'ionFlux', zKey:'voltage', xLabel:'j (А/м²)', yLabel:'Φ (м⁻²·с⁻¹)', zLabel:'U (В)', title:'Связь электрического тока и ионного потока', category:'flux' },
    84: { xKey:'ionFlux', yKey:'totalTransferredEnergy', zKey:'ionEnergy', xLabel:'Φ (м⁻²·с⁻¹)', yLabel:'E_total (Дж)', zLabel:'Eᵢ (эВ)', title:'Мощность энергопередачи', category:'flux' },
    85: { xKey:'ionFlux', yKey:'fluenceEffRatio', zKey:'resonanceXi', xLabel:'Φ (м⁻²·с⁻¹)', yLabel:'Φ_eff / Φ', zLabel:'ξ', title:'Коэффициент усиления потока', category:'flux' },
};
