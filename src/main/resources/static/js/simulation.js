...
const SimulationUI = {
    ...
    fillResults(result, simReq) {
        ...
        set('ps_skin_temperature_delta',   num(stats.skinTemperatureDelta));
        set('ps_effective_surface_temp',   num(stats.effectiveSurfaceTemperature));
        set('ps_energy_gain_factor',       num(stats.energyGainFactor));
        set('ps_plasma_correction_factor', num(stats.plasmaCorrectionFactor));
